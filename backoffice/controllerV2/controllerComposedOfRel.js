...
var ControllerComposedOfRel = module.exports = function ControllerComposedOfRel(_node) {
}
...
ControllerComposedOfRel.getComposedOfRels = function(callback)
{
    var query = 'MATCH (re:Recipe)-[r:COMPOSED_OF]-(i) RETURN r;';
